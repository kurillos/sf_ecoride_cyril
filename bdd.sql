...
CREATE TABLE review (
    id INT AUTO_INCREMENT NOT NULL,
    user_id INT DEFAULT NULL,
    rated_driver_id INT DEFAULT NULL,
    service_id INT DEFAULT NULL,
    rating INT NOT NULL,
    status VARCHAR(50) NOT NULL DEFAULT 'pending',
    PRIMARY KEY(id),
    INDEX IDX_794381C6A76ED395 (user_id),
    INDEX IDX_794381C640090886 (rated_driver_id),
    INDEX IDX_794381C6ED5CA9E6 (service_id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE review ADD CONSTRAINT FK_794381C640090886 FOREIGN KEY (rated_driver_id) REFERENCES user (id);
ALTER TABLE review ADD CONSTRAINT FK_794381C6ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id);
